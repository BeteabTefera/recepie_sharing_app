      ...
      >
        <div className="flex justify-end">
          <Button
            ...
            className={`bg-red-500 text-white hover:bg-orange-600 
            py-1 px-2 w-[50%]
            `}
          />
            ...
            >
                <div className="flex gap-4 items-start w-full">
                    ...
                    <div className="text-left">
                        <p className="text-red-500 font-light">{email}</p>
                    </div>
                </div>
                    <h2
                        className={`text-red-500 font-bold my-2 text-xl  ${
                    ...
                    {note && (
                        <p className="text-red-500 font-light text-sm py-1 md:py-4">
